...
function TableTransaksi({ }: Props) {
  ...
  const columnsDefs = React.useMemo<ColumnDef<Transaction>[]>(
    () => [
      {
        accessorKey: 'id',
        header: 'No',
      ...
      {
        accessorKey: 'product.seller.name',
  ...
  const dataQuery = useQuery(
    ...
    () => TransactionRepository.getAdmin({ limit: fetchDataOptions.pageSize, offset: fetchDataOptions.pageIndex, search: fetchDataOptions.searchTerm }),
      ...
      <Card>
        <Card.Header>
          <div className='d-flex align-items-center justify-content-between'>
            <Card.Title className="mb-0">Tabel Transaksi</Card.Title>
          </div>
        </Card.Header>
